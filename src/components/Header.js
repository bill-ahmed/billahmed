    ...
    let headerLinks = [
        {
            ...
            showInMobile: false     // Whether to show name in mobile display or not
        },
        {
            name: "LinkedIn",
